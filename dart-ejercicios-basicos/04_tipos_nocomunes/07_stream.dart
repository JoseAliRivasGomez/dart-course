...
main() {
  ...
  // final streamController = new StreamController<String>(); //solo 1 suscripcion
  final streamController = new StreamController<String>.broadcast(); //varias suscripciones
